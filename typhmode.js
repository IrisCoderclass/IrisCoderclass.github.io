...
function setup() {
  ...
  wheelSize = 24;
  speed = 10;
  var ster1 = new sterix(random(1000),1001);
  sterren.push(ster1);
  var ster2 = new steri(random(1000),-1001);
  sterren.push(ster2);
  var ster3 = new ster(random(1000),-950);
  sterren.push(ster3);
  var ster4 = new sters(random(1000),900);
  sterren.push(ster4);
  var ster5 = new sterix(random(1000),850);
  sterren.push(ster5);
  var ster6 = new steri(random(1000),-800);
  sterren.push(ster6);
  var ster7 = new ster(random(1000),-750);
  sterren.push(ster7);
  var ster8 = new sters(random(1000),700);
  sterren.push(ster8);
  var ster9 = new sterix(random(1000),650);
  sterren.push(ster9);
  var ster10 = new steri(random(1000),-600);
  sterren.push(ster10);

  var ster11 = new ster(random(1000),-550);
  sterren.push(ster11);
  var ster12 = new sters(random(1000),500);
  sterren.push(ster12);
  var ster13 = new sterix(random(1000),450);
  sterren.push(ster13);
  var ster14 = new steri(random(1000),-400);
  sterren.push(ster14);
  var ster15 = new ster(random(1000),-350);
  sterren.push(ster15);
  var ster16 = new sters(random(1000),300);
  sterren.push(ster16);
  var ster17 = new sterix(random(1000),250);
  sterren.push(ster17);
  var ster18 = new steri(random(1000),-200);
  sterren.push(ster18);
  var ster19 = new ster(random(1000),-150);
  sterren.push(ster19);
  var ster20 = new sters(random(1000),100);
  sterren.push(ster20);
  var ster21 = new sterix(random(1000),50);
  sterren.push(ster21);
  var ster22 = new steri(random(1000),0);
  sterren.push(ster22);
}
